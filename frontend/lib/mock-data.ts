...
export const mockAnalysisResult: AnalysisResult = {
  ...
  findings: [
    {
      id: "f1",
      title: "Yağlama Programı Değiştirildi",
      description: "Bakım aralığı 3. çeyrek maliyet düşürme çalışmasının bir parçası olarak 30 günden 60 güne çıkarıldı.",
      severity: "high",
      evidence: ["Bakım günlüğü girişi 2024-09-15", "Maliyet azaltma notu CR-2024-Q3-012"],
    },
    {
      id: "f2",
      title: "Sıcaklık Eğilimi Anomalisi",
      description: "Motor çalışma sıcaklığı son 6 haftadır istikrarlı bir şekilde artıyor.",
      severity: "medium",
      evidence: ["SCADA sıcaklık günlükleri", "Termal görüntüleme raporu TIR-2024-47"],
    },
  ],
  recommendations: [
